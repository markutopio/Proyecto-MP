...
typedef struct{
    ...
    char Contrasena[16];
    double Cartera; //dinero del que dispone el cliente para adquirir productos
...
typedef struct{
    ...
    int Num_unid;
    Fecha fecha_entre;
    double Importe; //debe registrarse el importe al que se compra un producto por si se modifica el importe posteriormente
